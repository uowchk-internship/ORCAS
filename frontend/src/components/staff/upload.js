...
export default function UploadComponent() {
  ...
  return (
    <>
      ...
      <div>
        <label style={labelStyle} htmlFor="programPlanUpload">
      ...
      <form>
        ...
        <label style={labelStyle} >Subject: (you can choose more than one) <span style={{ color: "#ED0A00" }}>*</span></label>
        ...
        <label style={labelStyle} >Resources Type: (choose one) <span style={{ color: "#ED0A00" }}>*</span></label>
