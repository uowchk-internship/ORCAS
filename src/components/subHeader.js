            ...
            <div className="grid-container blue-nav">
                <div className="page-navigator js-page-navigator">
                    <div className="grid-x page-navigator__button-wrapper">
                        <a href="#" className="page-navigator__button page-navigator__button--breadcrumbs js-page-navigator__button"
                            data-toggle="page-navigator__list--breadcrumbs">You are here<svg
                                className="svg-inline--fa fa-chevron-down fa-w-14" aria-hidden="true" data-prefix="fas"
                            ...
                            </svg><svg className="svg-inline--fa fa-times fa-w-11"
                        ...
                        <a href="#" className="page-navigator__button page-navigator__button--pages js-page-navigator__button"
                            data-toggle="page-navigator__list--pages">More Pages<svg className="svg-inline--fa fa-chevron-down fa-w-14"
